...
const (
	...
	// Calculate RPC.
	CalculatorServiceCalculateProcedure = "/CalculatorService/Calculate"
)

// CalculatorServiceClient is a client for the calculator.v1.CalculatorService service.
type CalculatorServiceClient interface {
	Calculate(context.Context, *connect.Request[CalculationRequest]) (*connect.Response[CalculationResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CalculatorServiceClient {
	...
	calculatorServiceMethods := File_calculator_v1_calculator_proto.Services().ByName("CalculatorService").Methods()
	return &calculatorServiceClient{
		calculate: connect.NewClient[CalculationRequest, CalculationResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect.Client[CalculationRequest, CalculationResponse]
}

// Calculate calls calculator.v1.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect.Request[CalculationRequest]) (*connect.Response[CalculationResponse], error) {
...
func NewCalculatorServiceHandler(svc CalculatorServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/CalculatorService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect.Request[CalculationRequest]) (*connect.Response[CalculationResponse], error) {
