...
type CalculationRequest struct {
	...
	Expression    string                 `protobuf:"bytes,1,opt,name=expression,proto3" json:"expression,omitempty"` // 表达式，例如 "1+1" 或 "1+1+1"
...
type CalculationResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Result        string                 `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"` // 计算结果
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_calculator_v1_calculator_proto_rawDesc = "" +
	"\n" +
	"\x1ecalculator/v1/calculator.proto\x12\rcalculator.v1\"4\n" +
	...
	"\tCalculate\x12!.calculator.v1.CalculationRequest\x1a\".calculator.v1.CalculationResponseB.Z,calculator-go/gen/calculator/v1;calculatorv1b\x06proto3"
